...
function change_table () {
    ...
    switch (true) {
        case (!isset($_GET['action'])&&$user_loged_in&&$user_role!=0&&!isset($_GET['user_profile'])&&!isset($_GET['article'])):
    ?>
            <header class="container-fluid row mt-1">
                ...
                <div class="col d-flex justify-content-end align-items-end mx-4">
                    <strong class="h1 pb-2"><?= $user_roles[$user_role] ?> <?= $user_name ?>
                        <a href="cosmodb.php?user_profile=<?= $user_name?>"  
                        role="button" 
