...
try {
    ...
    while ($row = $result -> fetch()) {
        ...
        <td class="text-center">
            ...
            <a href="cosmodb.php?table=<?= $table ?>&id_change_form%5B%5D=<?=$id?>&action=Удалить+выбранное"
            role="button" class="btn btn-danger d-inline-flex align-items-center justify-content-center px-2">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
